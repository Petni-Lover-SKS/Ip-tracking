...
stderr.writelines(f"""{Gr}
   ...
   ▒█▄▄█▀▒▐█▒▐▄ ▒█▄▄█▀👻👻👻👻👻👻 
                        SKS
      [this tool free for ⚔️ black Mafia ⚔️ ]

          {Wh}[ + ]  C O D E   B Y  SHALLOCK [ + ]  
...
if input_user == '1': #OPSI 1
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}--------------------------------
   :g g   :         {Wh}| {Gr} Mafia - TRACKER - IP ADDRESS {Wh}|
   : o    `.        {Wh}|       {Gr}@CODE BY Shallock     {Wh}|
  :         ``.     {Wh}--------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}| {Gr} Mafia - TRACKER - PHONE NUMBER {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY Shallock       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}|  {Gr} Mafia - SHOW YOUR IP ADDRESS  {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY Shallock       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
...
""")
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}|    {Gr} Mafia - TRACKER USERNAME    {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY Shallock      {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
...
""")
    ...
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}THANK'S FOR USING TOOL {Ye} Mafia--TRACK !")
else:
